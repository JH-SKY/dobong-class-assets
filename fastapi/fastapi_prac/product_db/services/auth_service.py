...
from product_db.repositories.user2_repository import user2_repository
from product_db.models.user2 import User2
from product_db.schemas.user2 import UserCreate, UserLogin
...
class AuthService:
    ...
    def signup(self, db: Session, data: UserCreate):
        with db.begin():
            ...
            # 3. 사용자 저장
            new_user = User2(
                email=data.email, password_hash=hashed_password, nickname=data.nickname
            )
